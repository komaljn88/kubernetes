...
func NewCmdXyz(f cmdutil.Factory, pathOptions *clientcmd.PathOptions, streams genericclioptions.IOStreams) *cobra.Command {
    return  NewCmdConfigUseContext(streams.Out, pathOptions)
}
